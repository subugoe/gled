        ...
        extends IdentifierProvider
{
            ...
            throws SQLException, DOIIdentifierException
    {
        ...
        else
        {
            ...
            //Add generated DOI to metadata 
            try
			{
				addDOIAsAdditionalMetadata(context, dso, doi);

			}
			catch (SQLException ex) {
				log.error("SQLException occurred while writing a DOI to additional metadata field of an item: "
						+ ex.getMessage());
			}catch (AuthorizeException ex) {
				log.error("Additional DOI field could not be written to metadata: Authorization error.");
			}
			catch (IdentifierException ex)
			{
				log.error("IdentifierException occurred while writing additional DOI field: " + ex.getMessage());
			}	
        }
            ...
            throws AuthorizeException, SQLException, IdentifierException
    {
        ...
        //remove additional doi metadata
        String doi_field_element = (this.configurationService.getProperty("doi.field.element") != null) ? this.configurationService.getProperty("doi.field.element")
                : "identifier";
        String doi_field_qualifier = (this.configurationService.getProperty("doi.field.qualifier") != null) ? this.configurationService.getProperty("doi.field.qualifier")
                : "doi";

        metadata = item.getMetadata(MD_SCHEMA, doi_field_element, doi_field_qualifier, null);
        ...
        item.clearMetadata(MD_SCHEMA, doi_field_element, doi_field_qualifier, null);
        item.addMetadata(MD_SCHEMA, doi_field_element, doi_field_qualifier, null,
                remainder.toArray(new String[remainder.size()]));
    ...
    /**
     * Adds a DOI to the metadata of an item in configurable special field.
     *
     * @param context
     * @param dso DSpaceObject the DOI should be added to.
     * @param doi The DOI that should be added as metadata.
     ...
     * @throws AuthorizeException
     */
    protected void addDOIAsAdditionalMetadata(Context context, DSpaceObject dso, String doi)
            throws SQLException, AuthorizeException, IdentifierException
    {
        // FIXME
        if (!(dso instanceof Item))
        ...
        String doi_field_qualifier = (this.configurationService.getProperty("doi.field.qualifier") != null) ? this.configurationService.getProperty("doi.field.qualifier")
                : "doi";
        item.addMetadata(MD_SCHEMA, doi_field_element,doi_field_qualifier, null, doi);
