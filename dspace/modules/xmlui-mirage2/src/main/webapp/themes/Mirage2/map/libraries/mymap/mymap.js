...
function onEachFeature(feature, layer) {
	 ...
	 if (feature.properties.Link1 != ""&& feature.properties.Link2 == ""){
        layer.bindPopup("<b>Title: </b>"+feature.properties.Title+"<br><b>Subtitle: </b>"+feature.properties.Subtitle+"<br><b>Links:</b><br><a href='"+feature.properties.Link1+"' target='_blank' title='"+feature.properties.ML1+"'>"+feature.properties.LText1+"</a>");
     }
