...
var mymap = L.map('mapid2').setView([50.3,9.3], 5);
...
var fidgeo_maps_layer = L.geoJson(geojson, {
  filter: function(feature, layer) {
    return (feature.properties.Layer === "GK50 / GEO-LEOe-docs");
  },style:fidgeo_Style,onEachFeature:onEachFeature
}).addTo(mymap);
...
var overlayMaps={
	  "<font color='#073291'><b>GK50/GEO-LEOe-docs</b></font>": fidgeo_maps_layer
	}
